...
public class ScrappingService {
    ...
    public List<ItemDAO> getItemFromEmag(String name)
    {
        ...
        for(Element content:contentPage) {
            ...
            String price;
            aux.setStringPrice(content.getElementsByClass("product-new-price")
                    .text());
    ...
    public List<ItemDAO> getItemFromFlanco(String name)
    {
            ...
            for(Element content:contentPage) {
                ...
                aux.setStringPrice(content.getElementsByClass("price").text().split(" ")[0]);
    ...
    {
        {
            ...
            for(Element content:contentPage) {
                ...
                aux.setStringPrice(content.getElementsByClass("Price-int").first().text());
